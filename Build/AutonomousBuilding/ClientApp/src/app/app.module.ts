...
@NgModule({
  ...
  providers: [NgbActiveModal, DetailsPeopleComponent, DetailsLocksComponent, DetailsSchedulesComponent,
    NavbarService, AuthenticationService, LogService, TimingSerivce, MobileService, FileService, AppComponent, DatePipe, AccountComponent, KeysComponent, LocksComponent,
